/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/api-proxy/wrangler.jsonc` (hash: 15de1b3aad6b82cf19af7d2745841577)
// Runtime types generated with workerd@1.20260722.1 2026-07-27 
interface __BaseEnv_Env {
	ORIGIN_HOST: "more-more-codeserver-production.up.railway.app";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/api-proxy/src/index");
	}
